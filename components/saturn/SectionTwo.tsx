        ...
        <div id='funds'>
            ...
            <section className='p-4 lg:p-20 pt-16 flex flex-col lg:flex-row gap-24 items-center text-[#080808]'>
                <div className='lg:w-[28rem]'>
                    ...
                    <p className="font-medium mb-10">
                        This fund offers a simple way to invest across different markets by spreading your money across cryptocurrencies, stocks, and alternative assets to help grow your wealth while managing risk.
                    </p>
                    <Link
