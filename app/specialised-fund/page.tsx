                ...
                <div>
                    ...
                    <section className='py-20 px-4 lg:p-20'>
                        ...
                        <p className='lg:w-[51rem] mb-16'>
                            This fund makes it easy to invest in the future of artificial intelligence. It gives you access to a mix of AI-focused companies and decentralized AI projects that use blockchain technology
                        </p>
                            ...
                            <div className='flex gap-6 flex-col lg:flex-row'>
                                <div className='border rounded-2xl p-5 pb-8 border-[#1639CE1A]'>
                                    ...
                                    <div>
                                        ...
                                        <Link
                                            href={"/login"}
                                            className='text-white py-4 px-6 rounded-xl bg-[#1639CE] block w-fit'
                                        >
                                            Invest Now
                                        </Link>
                                    </div>
                            ...
                            <div className='flex gap-6 mt-8 flex-col lg:flex-row'>
                                ...
                                <div className='border rounded-3xl border-[#1639CE1A] lg:w-[59%] mix-blend-multiply relative bg-[#000D45] p-9'>
                                    ...
                                    <div className='text-white relative z-30'>
                                        ...
                                        <a
                                            href="/brochure/The Specialised AI Fund.pdf"
